...
if $BUILD_TESTS; then
    ...
    docker_run '
        ...
        # UBThemeManager (QObject under test for #297 semantic roles / css())
        $MOC_BIN $MOC_COMMON_FLAGS \
        ...
        for HEADER in tst_UBGraphicsScene tst_UBVisualRegression tst_UBRecognition tst_UBSmoothStrokeItem tst_UBKeyboardPaletteColors tst_UBThemeManager tst_UBDisplayManager tst_UBExportSelection tst_UBPageDeletion tst_UBResizeGrip tst_UBTextDrag tst_UBTextVerticalAlign tst_UBHyperlink tst_UBPageNumber tst_UBBackgroundGrid tst_UBInkColorUtils tst_UBLibraryModel; do
            $MOC_BIN $MOC_COMMON_FLAGS \
                ${HEADER}.h \
