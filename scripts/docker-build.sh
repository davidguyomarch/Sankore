...
if $BUILD_TESTS; then
    ...
    docker_run '
        ...
        for HEADER in tst_UBGraphicsScene tst_UBVisualRegression tst_UBRecognition tst_UBSmoothStrokeItem tst_UBKeyboardPaletteColors tst_UBDisplayManager tst_UBExportSelection tst_UBPageDeletion tst_UBResizeGrip tst_UBTextDrag tst_UBTextVerticalAlign tst_UBHyperlink tst_UBBackgroundGrid tst_UBInkColorUtils; do
            $MOC_BIN $MOC_COMMON_FLAGS \
                ${HEADER}.h \
