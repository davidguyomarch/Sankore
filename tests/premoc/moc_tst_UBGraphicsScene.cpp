...
template <> constexpr inline auto TestUBGraphicsScene::qt_create_metaobjectdata<qt_meta_tag_ZN19TestUBGraphicsSceneE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        // Slot 'testDrawLineToCreatesPolygon'
        QtMocHelpers::SlotData<void()>(1, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'testDrawLineToZeroLengthSkipped'
        QtMocHelpers::SlotData<void()>(3, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'testMoveToResetsState'
        QtMocHelpers::SlotData<void()>(4, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'testInputDevicePressAndRelease'
        QtMocHelpers::SlotData<void()>(5, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'testMultipleSegmentsCreateStroke'
    ...
    return QtMocHelpers::metaObjectData<TestUBGraphicsScene, qt_meta_tag_ZN19TestUBGraphicsSceneE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject TestUBGraphicsScene::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN19TestUBGraphicsSceneE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN19TestUBGraphicsSceneE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN19TestUBGraphicsSceneE_t>.metaTypes,
    nullptr
} };
...
void *TestUBGraphicsScene::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN19TestUBGraphicsSceneE_t>.strings))
